...
const TOKEN_USAGE_DATA = [
  ...
  { agent: 'ML Agent', tokens: 112000, ms: 890, color: '#3B82F6' },
  { agent: 'Software Agent', tokens: 94800, ms: 650, color: '#6366F1' },
    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="bg-gradient-to-r from-emerald-950 via-slate-900 to-teal-950 border border-emerald-500/30 rounded-2xl p-6 shadow-xl text-white relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 max-w-2xl">
          ...
          <p className="text-slate-300 text-xs leading-relaxed">
            ...
            <span className="text-emerald-400 font-semibold"> PLANNER → Data Analyst → Research Agent → ML Agent → QA Agent → EXECUTIVE REPORT</span>.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="mt-1 text-xs text-slate-500">Autonomous Multi-Agent DAG Ready</p>
        </div>
